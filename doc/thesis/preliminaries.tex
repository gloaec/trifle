...
\acknowledgments {
  ...
  jamais été possible. Enfin, ces messieurs ont accepté d'être les rapporteurs
  de ce mémoire et je les en remercie, de même que pour leur participation au
  Jury.

  Je ne sais comment exprimer ma gratitude à tous les salariés de la société
  Cadoles pour m'avoir permit de mener à bien ce stage dans les meilleurs
  ...
  Je remercie tous ceux sans qui ce mémoire ne serait pas ce qu'il est : aussi
  bien par les discussions que j'ai eu la chance d'avoir avec eux, leurs
  suggestions ou contributions. Je pense ici en particulier à Daniel Dehennin et
  Gwenaël Rémond pour les conseils stimulants que j'ai eu le plaisir de recevoir
  et les orientations qu'ils ont donné à mes lectures.

  Pour leurs encouragements et leur assistance morale, je remercie chaudemment
  ma famille et mes amis. Merci à M. Romain Gauthier et Mlle. Camille Sintive
  pour avoir accepté d'effectuer un travail de relecture et qui par leurs
  nombreuses remarques et suggestions a permis d'améliorer la qualité de ce
  mémoire, je leur en suis très reconnaissant.
  ...
  Burgess, M. Gregory D. Abowd et M. Anind K. Dey à qui la majorité du travail
  sur la configuration autonome est due et qui m'ont largement rendu grâce à
  leur profonde érudition sur le sujet.
}
...
\thesisabstract {
  ...
  mémoire a pour objectif d'apporter une approche simplifiée de la gestion de la
  ...
  synchronistation entre les agents, de réplication de l'information et garantit
